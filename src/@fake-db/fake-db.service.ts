...
import {OemFakeData} from './oem.data';
import {RingFakeData} from './ring.data';
import {HarnessFakeData} from './harness.data';
import {CableFakeData} from './cable.data';
import {SubAssyFakeData} from './sub-assy.data';
import {ConnectorFakeData} from './connector.data';
import {ConnectorConfigFakeData} from './connector-config.data';
import {SubAssyPartsFakeData} from './sub-assy_parts.data';
import {ComponentFakeData} from "./component.data";
...
export class FakeDbService implements InMemoryDbService {
  createDb(): any {
    return {
      ...
      // PE DATA
      'oems': OemFakeData.data,
      'cables': CableFakeData.data,
      'components': ComponentFakeData.data,

      'ring-data': RingFakeData.data,
      'harness-data': HarnessFakeData.data,


      'subassy-data': SubAssyFakeData.data,
      'subassyParts-data': SubAssyPartsFakeData.data,

      'connector-data': ConnectorFakeData.data,
      'connector_config-data': ConnectorConfigFakeData.data,
