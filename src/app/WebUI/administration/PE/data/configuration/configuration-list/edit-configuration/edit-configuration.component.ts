...
export class EditConfigurationComponent implements OnInit  {
  ...
  async submit(form) {
    if (form.valid)
    {
      ...
      this.formData.append("id", this.configuration.id);
      ...
      await this._configurationService.UpdateAsync(this.formData,this.configuration.id);
   ...
   */
  ngOnInit(): void {
    this._configurationService.onItemChange.subscribe(res => {
