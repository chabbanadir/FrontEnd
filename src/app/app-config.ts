...
export const coreConfig: CoreConfig = {
  app: {
    appName     : 'E-Drawing',                                        // App Name
    appTitle    : 'TE - Drawing Generator Application', // App Title
    appLogoImage: 'assets/images/logo/te-connectivity-logo.png',                  // App Logo
    appLanguage : 'en',                                           // App Default Language (en, fr, de, pt etc..)
    TE_Logo: 'assets/images/logo/SIDEBAR.png'                  // App Logo
  },
  layout: {
